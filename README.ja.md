...
現在の公開版：**[v2.19.0](https://github.com/wukongnotnull/vole/releases/tag/v2.19.0)**（Developer ID 署名＋Apple 公証）。Apple Silicon / Intel 両対応。
...
例（Apple Silicon / v2.19.0。ファイル名は Release ページに合わせてください）：
