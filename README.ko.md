...
현재 공개 버전: **[v2.19.0](https://github.com/wukongnotnull/vole/releases/tag/v2.19.0)** (Developer ID 서명 및 Apple 공증). Apple Silicon·Intel 모두 제공.
...
예 (Apple Silicon / v2.19.0; 파일명은 Release 페이지 기준):
