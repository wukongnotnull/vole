...
현재 공개 버전: **[v2.18.0](https://github.com/wukongnotnull/vole/releases/tag/v2.18.0)** (Developer ID 서명 및 Apple 공증). Apple Silicon·Intel 모두 제공.
...
예 (Apple Silicon / v2.18.0; 파일명은 Release 페이지 기준):
...
규칙과 안전 아이디어는 [Mole](https://github.com/tw93/Mole)에서 영감을 받았습니다. Vole은 독립 오픈소스이며 Mole에 소속되지 않습니다.  
