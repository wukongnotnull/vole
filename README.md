...
**预编译包**（GitHub Release [v0.0.8](https://github.com/wukongnotnull/vole/releases/tag/v0.0.8)，**Developer ID 签名**）：
...
| Phase 5 `history` + 协议冻结 + 菜单 / 补全 | 可用；**v0.0.8** Developer ID Release（470 规则） |
