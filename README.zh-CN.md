...
当前已发布版本：**[v2.19.0](https://github.com/wukongnotnull/vole/releases/tag/v2.19.0)**（Developer ID 签名并经 Apple 公证）。Apple Silicon 与 Intel 均有对应安装包。
...
示例（Apple Silicon / v2.19.0；请以 Release 页实际文件名为准）：
