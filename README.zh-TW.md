...
目前已發布版本：**[v2.15.0](https://github.com/wukongnotnull/vole/releases/tag/v2.15.0)**（Developer ID 簽名並經 Apple 公證）。Apple Silicon 與 Intel 均有對應安裝包。
...
範例（Apple Silicon / v2.15.0；請以 Release 頁實際檔名為準）：
