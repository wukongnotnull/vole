...
pub use tasks::{
    ...
    plan_sqlite_vacuum, plan_system_maintenance, FakeLoginItemsAuditDeps, FakeSpotlightOrphanDeps,
    LiveLoginItemsAuditDeps, LiveSpotlightOrphanDeps, LoginItemSnapshot, LoginItemsAuditDeps,
    OptimizeActionError, OptimizeCandidate, SpotlightOrphanDeps, SpotlightOrphanError,
