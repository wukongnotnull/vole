...
- 日期：2026-08-08（修订：同日 W2b② `memory_pressure_relief` / 1.36.0 合入后更新状态）
...
| **W2a/b/c** | W0/W1 已解除阻塞；三轨彼此可并行；**轨内串行发版**；**W2b①② / W2c 首刀 / W2a①②③ 已完成**；**当前推荐**续挑窄项 | 可删 / 需特权 action |
| **W3** | 不开发 | 永不做 / 延后 |
...
- **并行**：与 W2a / W2b 并行；首刀已合入后 **Batch 6+ 仍可继续挑窄 `all` 规则**（单刀单 PR · 与 W2b③ 并列可选）。
...
10. W2 其余按各轨内顺序（spotlight* 等后置择优）
11. **W3** 仅维持 coverage / README 诚实句，不排开发

## 4. 与既有文档关系

| 文档 | 关系 |
|---|---|
| [`2026-08-08-0025-mole-system-sh-backlog-design.md`](2026-08-08-0025-mole-system-sh-backlog-design.md) | **system 对照表仍权威**；本文件为其 **超集**；W0/W1/W2a①②③/W2b①②/W2c 首刀状态以本文件为准 |
...
- [x] W0/W1/W2a①②③/W2b①②/W2c 首刀状态与 main（1.28.0 / 1.29.0 / 1.33.0 / 1.34.0 / 1.35.0 / 1.31.0 / 1.36.0 / 1.32.0）一致

下一步：从 §3 第 9 项（**默认 W2b③** 网络栈/权限/periodic，或 W2c Batch 6+）选刀 → 单独 design + implementation plan。
